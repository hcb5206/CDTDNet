...
# import SRU_lag
from Bi_SRU_lag_f import SRU_2layers
"""
双向SRU
"""
...
class BidirectionalSRU(nn.Module):
    def __init__(self, input_size, hidden_size):
        ...
        self.forward_sru = SRU_2layers.MultiLayerSRU(input_size, hidden_size)
        self.backward_sru = SRU_2layers.MultiLayerSRU(input_size, hidden_size)
